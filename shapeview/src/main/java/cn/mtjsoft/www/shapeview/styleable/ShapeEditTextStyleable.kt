...
class ShapeEditTextStyleable : IStyleable {
    override val shape: Int
        get() = R.styleable.ShapeEditText_sv_shape
    override val solidColor: Int
        get() = R.styleable.ShapeEditText_sv_solidColor
    override val strokeColor: Int
        get() = R.styleable.ShapeEditText_sv_strokeColor
    override val startColor: Int
        get() = R.styleable.ShapeEditText_sv_startColor
    override val centerColor: Int
        get() = R.styleable.ShapeEditText_sv_centerColor
    override val endColor: Int
        get() = R.styleable.ShapeEditText_sv_endColor
    override val startSelectColor: Int
        get() = R.styleable.ShapeEditText_sv_startSelectColor
    override val centerSelectColor: Int
        get() = R.styleable.ShapeEditText_sv_centerSelectColor
    override val endSelectColor: Int
        get() = R.styleable.ShapeEditText_sv_endSelectColor
    override val orientation: Int
        get() = R.styleable.ShapeEditText_sv_orientation
    override val gradientType: Int
        get() = R.styleable.ShapeEditText_sv_gradientType
    override val gradientRadius: Int
        get() = R.styleable.ShapeEditText_sv_gradientRadius
    override val strokeWidth: Int
        get() = R.styleable.ShapeEditText_sv_strokeWidth
    override val dashWidth: Int
        get() = R.styleable.ShapeEditText_sv_dashWidth
    override val dashGap: Int
        get() = R.styleable.ShapeEditText_sv_dashGap
    override val radius: Int
        get() = R.styleable.ShapeEditText_sv_radius
    override val topLeftRadius: Int
        get() = R.styleable.ShapeEditText_sv_topLeftRadius
    override val topRightRadius: Int
        get() = R.styleable.ShapeEditText_sv_topRightRadius
    override val bottomLeftRadius: Int
        get() = R.styleable.ShapeEditText_sv_bottomLeftRadius
    override val bottomRightRadius: Int
        get() = R.styleable.ShapeEditText_sv_bottomRightRadius
