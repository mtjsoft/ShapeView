...
public class ShapeRadioButton extends AppCompatRadioButton {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        topRightRadius = ta.getDimensionPixelSize(R.styleable.ShapeRadioButton_topRightRadius, radius);
        bottomLeftRadius = ta.getDimensionPixelSize(R.styleable.ShapeRadioButton_bottomLeftRadius, radius);
        bottomRightRadius = ta.getDimensionPixelSize(R.styleable.ShapeRadioButton_bottomRightRadius, radius);
        //选择器
        ...
        solidSelectColor = ta.getColor(R.styleable.ShapeRadioButton_solidSelectColor, Color.TRANSPARENT);
        strokeSelectColor = ta.getColor(R.styleable.ShapeRadioButton_strokeSelectColor, Color.TRANSPARENT);
        ta.recycle();
    }
}
